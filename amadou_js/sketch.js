...
function drawRace() {
  ...
  noStroke();
  fill(0);
  rect(startLine, 0, 5, height + 400);
  fill(0, 255, 0);
  rect(finishLine, 0, 20, height + 400);
}
...
function drawCaterpillar(x, y, segments) {
  ...
  // to form the body.
  //random color for caterpillar
  let colorR = random(50, 255);
  let colorG = random(50, 255);
  let colorB = random(50, 255);
